    ...
    */
    $.fn.peerbind = function(/*optional settings,*/ type, data, fn, isOnce) {
        ...
        function postPeerEvent(e, selector) {
            ...
            var eventObjectString = '{"src":"'+$.fn.peerbind.defaults.uuid+'","s":"'+selector+'","t":"'+e.type+
                    (e.keyCode ? '","k":"'+e.keyCode : '')+
                    (e.charCode ? '","c":"'+e.charCode: '')+
                    (e.pageX ? '","px":"'+e.pageX+'","py":"'+e.pageY  : '') +'","d":"'+
            ...
            //a specific queue.
            if ( e.peerTarget )
                url += '&q='+encodeURIComponent(e.peerTarget);
